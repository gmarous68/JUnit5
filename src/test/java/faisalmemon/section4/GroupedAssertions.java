...
public class GroupedAssertions {
    ...
    public void groupAssertionDemo() {
        ...
        Assertions.assertAll(() ->
                        Assertions.assertEquals(5, javaOperations.add(3, 2)),
                () -> Assertions.assertEquals(26, javaOperations.add(3, 23)),
                () -> Assertions.assertEquals(101, javaOperations.add(70, 31))
        );
    }
}